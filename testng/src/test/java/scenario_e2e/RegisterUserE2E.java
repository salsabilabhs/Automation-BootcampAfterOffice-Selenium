...
public class RegisterUserE2E {
    ...
    */
    ...
    public void RegisterUser() {
        ...
        Assert.assertEquals(resRegister.jsonPath().getString("email"), "mamang_60@gmail.com",
            "Expected email mamang_60@gmail.com, but got " + resRegister.jsonPath().getString("email"));
