...
public class RestAssuredImplement {
    ...
    // @Test(dependsOnMethods = "testAPILogin_Positive_Positive")
    public void testAPIRegister_Positive() {
        RestAssured.baseURI = "https://whitesmokehouse.com";
        
        String bodyRegister = "{"
                        + "\"email\": \"salsabilabhs10@gmail.com\","
        ...
        Response response = RestAssured.given()
            ...
            assert response.statusCode() == 200 : "Expected status code 200, but got " + response.statusCode();
            assert response.jsonPath().getString("email").equals("salsabilabhs10@gmail.com") : "Expected email salsabilabhs10@gmail.com, but got " + response.jsonPath().getString("email");
    ...
    public void testAPIPartiallyUpdateObject() {
        ...
        assert response.jsonPath().getString("data.cpu_model").equals("-") : "Expected cpu_model '-', but got " + response.jsonPath().getString("data.cpu_model");
        ...
        assert response.jsonPath().getString("data.capacity").equals("-") : "Expected capacity '-', but got " + response.jsonPath().getString("data.capacity");
